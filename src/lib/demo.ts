...
export function demoPolicies(): Policy[] {
  return [
    { id: 'Policy0', label: t('demoPolicyMain') },
    { id: 'Policy1', label: t('demoPolicyKids') },
    { id: 'Policy2', label: t('demoPolicyGuest') },
  ];
}
...
export async function setDemoDevicePolicy(
  ...
  if (policyId !== null && !demoPolicies().some((policy) => policy.id === policyId)) {
